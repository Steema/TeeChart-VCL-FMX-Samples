...
uses
  ...
  FMXTee.Series.Donut, FMXTee.Gauges.Numeric, FMXTee.Gauges.Linear,
  FMXTee.Gauges.Circular, FMXTee.Gauges.Knob, FMXTee.Engine, FMXTee.Tools,
  FMXTee.Functions.Stats, FMXTee.Series.Error, FMXTee.Series.Surface,
  FMX.StdCtrls, FMXTee.Commander, FMXTee.Series.Bar3D, FMXTee.Procs,
  FMXTee.Chart, FMX.Controls.Presentation, FMXTee.Canvas;
...
procedure TMainForm.AddHighLow;
var
...
procedure TMainForm.AddToMultiSeries;
var
  Delta1,
  //Delta2,
  Delta3: Double;
...
procedure TMainForm.Chart2AfterDraw(Sender: TObject);
Var x,y : Integer;
begin
...
procedure TMainForm.Chart3AfterDraw(Sender: TObject);
Var x,y : Integer;
begin
...
procedure TMainForm.Chart4AfterDraw(Sender: TObject);
Var x,y : Integer;
begin
...
procedure TMainForm.Chart6BeforeDrawSeries(Sender: TObject);
Var pRight : Integer;
begin
...
procedure TMainForm.Chart7AfterDraw(Sender: TObject);
begin
...
procedure TMainForm.Chart9AfterDraw(Sender: TObject);
Var x,y : Integer;
begin
...
procedure TMainForm.ConfigGauge1;
begin
  ...
  CircularGauge1.RedLine.Brush.Color := TAlphaColors.Red;
...
procedure TMainForm.ConfigGauge2;
Var dValue : Double;
begin
  Donut1.Clear;
...
procedure TMainForm.ConfigGauge3;
Var dValue : Double;
begin
  // donut2
...
procedure TMainForm.ConfigGauge4;
Var dValue : Double;
begin
  Donut3.Clear;
  dValue := Random * 1000;
...
procedure TMainForm.ConfigGauge5;
Var dValue : Double;
begin
  Donut4.Clear;
  dValue := Random * 1000;
...
procedure TMainForm.ConfigHarmonics;
begin
...
procedure TMainForm.ConfigMultiSeries;
var
  StartDT: Double;
  I: Integer;
begin
...
procedure TMainForm.ConfigSurface;
var
...
procedure TMainForm.DoTimerTick;
begin
  if deltaM then
  begin
    m := m + 10;
...
begin
  ...
  Panel2.Position.X := Panel1.Position.X+Panel1.Width;
  Panel3.Position.X := Panel1.Position.X+Panel1.Width + Panel2.Position.X+Panel2.Width;
  ...
  Chart5.Foot.Top := Round(Chart5.BoundsRect.Height - 32);
end;
...
procedure TMainForm.RotateSurface;
begin
...
procedure TMainForm.FillHarmonic;
var
  a: Double;
  n, k: Integer;
begin
