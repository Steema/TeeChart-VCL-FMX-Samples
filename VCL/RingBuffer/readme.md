...
The ring ([circular](https://en.wikipedia.org/wiki/Circular_buffer)) buffer is just an array you can specify its type and length, and then just keep adding points to the buffer.
