...
{ Copyright (c) 2003-2024 by Steema Software }
{        All Rights Reserved                 }
{********************************************}
...
begin
  ...
  CBGalleryRender.ItemIndex:=TeeReadIntegerOption(TeeMsg_GalleryRender,0);
...
begin
  ...
  if CBGalleryRender.ItemIndex<>TeeReadIntegerOption(TeeMsg_GalleryRender,0) then
